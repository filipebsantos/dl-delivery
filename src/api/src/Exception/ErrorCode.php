...
enum ErrorCode: int
{
    ...
    case CLIENT_INVALID_LOCATION_COORDINATE = 3004;
    case CLIENT_LOCATION_IMAGE_INVALID_TYPE = 3005;
    case CLIENT_LOCATION_IMAGE_INVALID_SIZE = 3006;
    case CLIENT_LOCATION_MISSING_PAYLOAD = 3007;
}