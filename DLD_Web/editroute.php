                                ...
                                <tbody class="table-group-divider">
                                    <?php foreach ($routeLocations as $rLocation) : ?>
                                        <tr scope="row">
                                            ...
                                            <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalMap<?= $rLocation["id"] ?>"><i class="bi bi-map-fill"></button></td>
                                            <td><button type="button" class="btn btn-<?= $rLocation["housepicture"] == null ? "secondary" : "primary" ?> btn-sm" data-bs-toggle="modal" data-bs-target="#modalPicture<?= $rLocation["id"] ?>"><i class="bi bi-camera-fill"></i></button></td>
                                            <td>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                <img loading="lazy" src="<?= $rLocation["housepicture"] !== null ? $BASE_URL . "imgs/houses/" . $rLocation["housepicture"] : $BASE_URL . "imgs/picture.jpg" ?>" width="600" height="auto" alt="">
                                                <div class="row">
                                                    <div class="col">
                                ...
                                <div class="modal fade" id="modalMap<?= $rLocation["id"] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                <iframe loading="lazy" height="500" width="700" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.br/maps?width=100%25&amp;height=400&amp;hl=pt&amp;gl=BR&amp;q=<?= $rLocation["latitude"] ?>,%20<?= $rLocation["longitude"] ?>&amp;t=&amp;z=16&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                                            </div>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody class="table-group-divider">
                                                <?php foreach ($client_locations as $location) : ?>
                                                    <tr scope="row">
                                                        <td><?= $location["type"] ?></td>
                                                        <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#picLocMap<?= $location["id"] ?>"><i class="bi bi-map-fill"></button></td>
                                                        <td><button type="button" class="btn btn-<?= $location["housepicture"] == null ? "secondary" : "primary" ?> btn-sm" data-bs-toggle="modal" data-bs-target="#picLoc<?= $location["id"] ?>"><i class="bi bi-camera-fill"></i></button></td>
                                                        <td>
                            ...
                            <div class="modal fade" id="picLoc<?= $location["id"] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            <img loading="lazy" src="<?= $location["housepicture"] !== null ? $BASE_URL . "imgs/houses/" . $location["housepicture"] : $BASE_URL . "imgs/picture.jpg" ?>" width="600" height="auto" alt="">
                            ...
                            <div class="modal fade" id="picLocMap<?= $location["id"] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            <iframe loading="lazy" height="500" width="700" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.br/maps?width=100%25&amp;height=400&amp;hl=pt&amp;gl=BR&amp;q=<?= $location["latitude"] ?>,%20<?= $location["longitude"] ?>&amp;t=&amp;z=16&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                                        </div>
                                        <div class="modal-footer">
                                            <button class="btn btn-primary" data-bs-target="#modalLocationList" data-bs-toggle="modal">Voltar para lista</button>
                                        </div>
