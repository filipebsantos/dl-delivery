...
if (isset($_GET["id"])) {
    ...
    $loadedData = $clientData->getClient($_GET["id"]);
    if (!$loadedData) {
            ...
            <div id="page-content" class="col-auto col-md-7">
                ...
                <?php else : ?>
                    <div class="container text-center mt-4">
                        <h4 class="mb-4">Tem certeza que deseja exluir '<?= $loadedData["name"] ?>'?</h4>
                        <form action="<?= $BASE_URL ?>clientprocess.php" method="post">
                            ...
                            <a href="<?= $BASE_URL ?>client.php" class="btn btn-danger"><i class="bi bi-x-lg"></i> Não</a>
                        </form>
                    </div>
                <?php endif; ?>
            </div>
